...
public class DetailActivity extends AppCompatActivity implements
    ...
    private static final int ID_DETAIL_LOADER = 185;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHighTempView = (TextView) findViewById(R.id.high_temp);
        mLowTempView = (TextView) findViewById(R.id.low_temp);
        ...
        switch (id) {
            case ID_DETAIL_LOADER:
                return new CursorLoader(this,
                        ...
                        null);
            default:
                throw new RuntimeException("Not Detail loader id");
        }
    }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        mForecastSummary = String.format("%s - %s - %s/%s",
                date, description, highTemp, lowTemp);
    }
